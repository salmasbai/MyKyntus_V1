...
const badgeClass = (action: string) => {
  if (action.toLowerCase().includes('soumis')) return 'bg-blue-500/15 text-blue-300 border-blue-500/30';
  if (action.toLowerCase().includes('vers')) return 'bg-violet-500/15 text-violet-300 border-violet-500/30';
  if (action.toLowerCase().includes('valid')) return 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30';
