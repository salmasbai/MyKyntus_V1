...
const badgeClass = (action: string) => {
  if (action === 'Generated') return 'bg-blue-500/15 text-blue-300 border-blue-500/30';
  if (action === 'Downloaded') return 'bg-violet-500/15 text-violet-300 border-violet-500/30';
  if (action === 'Approved') return 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30';
