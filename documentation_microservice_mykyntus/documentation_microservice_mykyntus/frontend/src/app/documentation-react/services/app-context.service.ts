...
export class AppContextService {
  ...
  private readonly messages: Record<string, string> = {
    ...
    'nav.myDocs': 'Mes docs',
    'nav.requestDoc': 'Demande',
    'nav.requestTracking': 'Suivi',
    'nav.notifications': 'Notifs',
    'nav.settings': 'Réglages',
    'nav.teamDocs': 'Docs équipe',
    'nav.teamRequests': 'Demandes équipe',
    'nav.allRequests': 'Demandes RH',
    'nav.hrDocHistory': 'Historique',
    'nav.docGen': 'Génération',
    'nav.templates': 'Modèles',
    'nav.adminConfig': 'Config docs',
    'nav.docTypes': 'Types docs',
